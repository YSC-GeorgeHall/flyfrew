...
<div class="jumbotron" style="padding-bottom: 15px;">
  <div class="row flex align-items-center">
    ...
    <div class="col-md-6">
    <h1 style>FlyFrew Transfers</h1>
        <div class="row">
        <div class="col-md-12">
        <h4>FlyFrew Airport uses existing airport partners to integrate and seemlessly connect them with travellers</h4></br>
        <a href="fftransfer-demo.php" class="btn btn-outline-primary" role="button" aria-pressed="true">FlyFrew Transfers Demo</a>
</div>  
</div>

    </div>
    <div class="col-md-6">
      <img src="images/transfer.png" class="img-fluid" alt="Responsive image">
    </div>
  </div>
</div>
<div class="row">
