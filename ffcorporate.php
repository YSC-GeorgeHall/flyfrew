...
<div class="jumbotron" style="padding-bottom: 15px;">
  <div class="row flex align-items-center">
    ...
    <div class="col-md-6">
    <h1 style>FlyFrew Corporate</h1>
        <div class="row">
        <div class="col-md-12">
        <h4>FlyFrew Airport uses existing airport partners to integrate and seemlessly connect them with travellers</h4></br>
        <a href="ffcorporate-demo.php" class="btn btn-outline-primary" role="button" aria-pressed="true">FlyFrew Corporate Demo</a>
</div>  
</div>

    </div>
    <div class="col-md-6">
      <img src="images/corporate.png" class="img-fluid" alt="Responsive image">
    </div>
  </div>
</div>
<div class="row">
    <div class="col-md-6">
        <h2>Travel needs moderisation</h2><br><p>In a world where everything is available at your fingers tips, travelling is still the odd one out. Travellers are still required to hold multiple different documents, show these multiple times, walk through a mariad of shops and spend time trying to find things in a complex stressful environment. FlyFrew Airport wants to change this.</p>
    </div>
    <div class="col-md-6">
        image
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <h2>Know the Airport User</h2><br><p>Airports should know their travellers (airlines do), they should know when a traveller is coming, what they are purpose is, and what they expect from their time at the airport. Not only this, people that are at the airport not to travel are forgotten, you may be dropping off, picking up, going to work, and we want to fix this. Airports should hold a serious relationship with those that attend the airport, and understand the needs of each and everyone of them.</p>
    </div>
</div>

<div class="row">
    <div class="col-md-6">
        <h2>Using Existing Relationships</h2><br><p>Using existing airport partners, a strong and important relationship with airport users FlyFrew Airport will give your airport a best in class solution to provide all airport users an unforgettable experience and enhance revenue opportunities for the airport</p>
    </div>
    <div class="col-md-6">
    image       
    </div>
